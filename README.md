...
## How to play
Next Point aims to bring a fast-paced, fun tennis simulation to the Next, with a focus on playability. Controls are intuitive: move around the court using the joystick or customized keys, and hit the ball with the fire button. The game intelligently selects the appropriate shot — drive, backhand or smash.
...
- Some instability issues still to be ironed out
## Credits
...
- This game uses the font [Audiowide](https://fonts.google.com/specimen/Audiowide) font by Astigmatic, licensed under the SIL Open Font License (OFL).
