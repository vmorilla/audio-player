...
PUBLIC MONO_BUFFER_SIZE, STEREO_BUFFER_SIZE, SOUND_EOF_MARKER
PUBLIC stereo_samples_buffer, mono_samples_buffer

EXTERN stereo_samples_channel, mono_samples_channel
EXTERN set_mmu_data_page_di, restore_mmu_data_page_di
EXTERN SC_CURSOR, SC_REMAINING_BUFFERS

defc STEREO_BUFFER_SIZE_BITS = 10 ; 11 bits -> 2048 bytes stereo buffer, 10 bits -> 1024 bytes stereo buffer
defc STEREO_BUFFER_SIZE = 2 ** STEREO_BUFFER_SIZE_BITS
defc STEREO_BUFFER_H_MASK = (STEREO_BUFFER_SIZE - 1) >> 8
defc STEREO_BUFFER_H_OVERFLOW_BIT = STEREO_BUFFER_SIZE_BITS - 8
defc STEREO_DOUBLE_BUFFER_H_OVERFLOW_BIT = STEREO_BUFFER_H_OVERFLOW_BIT + 1

defc MONO_BUFFER_SIZE_BITS = 9 ; 11 bits -> 2048 bytes stereo buffer, 10 bits -> 1024 bytes stereo buffer
